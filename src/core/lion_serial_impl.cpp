...
using lion::MillisecondTimer;
using lion::Serial;
using lion::SerialException;
using lion::PortNotOpenedException;
using lion::IOException;
...
void
Serial::SerialImpl::setTimeout (lion::Timeout &timeout)
{
  timeout_ = timeout;
}
...
void
Serial::SerialImpl::setBytesize (lion::bytesize_t bytesize)
{
  bytesize_ = bytesize;
  if (is_open_)
    reconfigurePort ();
...
void
Serial::SerialImpl::setParity (lion::parity_t parity)
{
  parity_ = parity;
  if (is_open_)
    reconfigurePort ();
...
void
Serial::SerialImpl::setStopbits (lion::stopbits_t stopbits)
{
  stopbits_ = stopbits;
  if (is_open_)
    reconfigurePort ();
...
void
Serial::SerialImpl::setFlowcontrol (lion::flowcontrol_t flowcontrol)
{
